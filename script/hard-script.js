...
const gridGenerator = () => {
    ...
    for (let i = 0; i < 5; i++) {
        for (let j = 0; j < 5; j++) {
            ...
            div.innerHTML = `<img src="../assets/hard/dexter${imagesArr[count]
                }.png" class="image ${imagesArr[count] == 25 ? "target" : ""
...
const selectImage = (e) => {
    ...
    if (checkAdjacent(row1, row2, col1, col2)) {
        ...
        //Win condition
        if (imagesArr.join("") == "12345678910111213141516171819202122232425") {
            setTimeout(() => {
