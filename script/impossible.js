...
const gridGenerator = () => {
    ...
    for (let i = 0; i < 6; i++) {
        for (let j = 0; j < 6; j++) {
            ...
            div.innerHTML = `<img src="../assets/imposible/dexter${imagesArr[count]
                }.png" class="image ${imagesArr[count] == 36 ? "target" : ""
...
const selectImage = (e) => {
    ...
    if (checkAdjacent(row1, row2, col1, col2)) {
        ...
        //Win condition
        if (imagesArr.join("") == "123456789101112131415161718192021222324252627282930313233343536") {
            setTimeout(() => {
